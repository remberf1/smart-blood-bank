    ...
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mt-5 flex justify-center">
          <Link
            href="/sos"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-red-100/90 text-red-700 font-semibold text-sm border border-red-200 hover:bg-red-200/90 transition-all shadow-sm"
          >
            <span className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-red-600"></span>
            </span>
            🚨 Life-or-Death Emergency? Trigger Instant SOS to Nearest Hospital & Donors →
          </Link>
        </div>

        <div className="mt-5 flex flex-wrap gap-x-5 gap-y-2 justify-center text-sm">
